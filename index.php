...
for ($i = 0; $i < 100; $i++) {
	///$router->addAlias('controller', 'action', 'alisas' . $i);
}
$router->tree();
echo '<span style="position:absolute; bottom:10px; right:10px; color:red;">' . (memory_get_usage() - $startMemory) / 1024 . ' kb' . PHP_EOL . '</span>';
